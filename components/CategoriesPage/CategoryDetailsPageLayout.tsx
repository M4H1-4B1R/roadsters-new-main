...
interface CategoryDetailsPageLayoutProps {
    category: Category;
    categoriesResponse: CategoriesResponse;
}

export default function CategoryDetailsPageLayout({
    category,
    categoriesResponse,
}: CategoryDetailsPageLayoutProps) {
    ...
    // Fetch products for this category when any filter or page changes
    useEffect(() => {
        async function fetchProducts() {
            setLoading(true);
            try {
                const filters: Record<string, string | number | boolean | undefined> = {
                    category: category.slug, // Filter by this category
                    min_price,
                    max_price,
                    sort,
                    page,
        ...
        fetchProducts();
    }, [category.slug, min_price, max_price, sort, in_stock, page]);
    ...
    const categoryName = locale === "ar" ? category.name_ar || category.name : category.name;
                ...
                <div className="text-center mb-8">
                    ...
                    {category.description && (
                        <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
                            {locale === "ar" ? category.description_ar || category.description : category.description}
                        </p>
                    )}
                </div>
